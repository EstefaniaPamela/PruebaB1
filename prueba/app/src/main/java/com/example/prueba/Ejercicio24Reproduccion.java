...
public class Ejercicio24Reproduccion extends AppCompatActivity {
    MediaPlayer mp;
    Button b5;
    int posicion = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ejercicio24_reproduccion);
    }
    ...
    public void iniciar(View v) {
        destruir();
        mp = MediaPlayer.create(this, R.raw.wayayay);
        mp.start();
